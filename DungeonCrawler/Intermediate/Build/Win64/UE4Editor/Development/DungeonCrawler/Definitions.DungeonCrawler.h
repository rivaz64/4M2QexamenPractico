...
#define UE_PROJECT_NAME DungeonCrawler
#define UE_TARGET_NAME DungeonCrawlerEditor
#define UE_MODULE_NAME "DungeonCrawler"
...
#define DUNGEONCRAWLER_API DLLEXPORT
